...
- Deterministic `pan-v2` camera playback is implemented. Transition/cold-render analysis, broader visual/HiDPI acceptance, and lower-end testing remain open.
...
| `canUseRetainedCartography` | Layer and map-mode animations disable retained cartography paths | Investigate prepared transition endpoints |
